...
from trans_novel.benchmark.review.artifacts import ReviewArtifactError
...
class TestBenchmarkReview(unittest.TestCase):
    def test_review_facade_exports_review_spec(self) -> None:
        spec = ReviewSpec(
            schema_version=1,
            benchmark_id="review-test",
            run_sha256="a" * 64,
        ...
        self.assertEqual(spec.shard_count, 8)
